...
/******************************************************************************/
/**
 * The <code>SecurityMenu</code> class sets up the Security menu for
 * the ObsCat GUI applet and application.  This menu permits the User
 * to select an identity that has been assigned database access
 * privileges.
 *
...
public class SecurityMenu extends JMenu
{

  /****************************************************************************/
  /**
   * Constructs the Security menu.
   */

  public SecurityMenu( LoginListener loginListener )
  {
    super( "Security" );
