...
public class ACISFormView extends FormView 
{
  /****************************************************************************/
  /**
   * Construct a ACISFormView object.
   */
   ...
   * used to (possibly) insert a new record into the acisparam table.
   */

  public void createNewRecordView()
  {
    // Create a new view to deal with creating a new record.
    editor.createView( "gov.sao.asc.obsed.view.form.ACISNewView",
		       "acisparam", "New ACIS", newKeyValue );
  }
