...
/******************************************************************************/
/**
 * Shows the soe table plus in a form view.
 *
...
public class SOEFormView extends FormView 
{
  /****************************************************************************/
  /**
   * Construct a SOEFormView object.
   */
   ...
   * used to (possibly) insert a new record into the soe table.
   */
  ...
  public void createNewRecordView()
  {
    ...
    //  editor.createView("gov.sao.asc.obsed.view.form.SOENewView",
    //		       "soe", "New SOE", newKeyValue );
  }
