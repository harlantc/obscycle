...
/******************************************************************************/
/**
 * Shows the phasereq table plus in a form view.
 *
...
public class PhaseReqFormView extends FormView 
{
  /****************************************************************************/
  /**
   * Construct a PhaseReqFormView object.
   */

  public PhaseReqFormView()
  {
    super();
  }
   ...
   * used to (possibly) insert a new record into the phasereq table.
   */
  ...
  public void createNewRecordView()
  {
    ...
    // Stub out the "New" feature for the time being 'til we know for
    // sure if we can do this...

    //  editor.createView("gov.sao.asc.obsed.view.form.PhaseReqNewView",
    //		       "phasereq", "New Phase Req", newKeyValue );
  }
