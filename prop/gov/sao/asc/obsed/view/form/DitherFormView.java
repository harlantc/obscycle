...
/******************************************************************************/
/**
 * Shows the dither table plus in a form view.
 *
...
public class DitherFormView extends FormView 
{
  /****************************************************************************/
  /**
   * Construct a DitherFormView object.
   */

  public DitherFormView()
  {
    super();
  }
   ...
   * used to (possibly) insert a new record into the dither table.
   */
  ...
  public void createNewRecordView()
  {
    ...
    //  editor.createView("gov.sao.asc.obsed.view.form.DitherNewView",
    //		       "dither", "New Dither", newKeyValue );
  }
