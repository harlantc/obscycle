...
/******************************************************************************/
/**
 * Shows the mp table plus in a form view.
 *
...
public class MPFormView extends FormView 
{
  /****************************************************************************/
  /**
   * Construct a MPFormView object.
   */
   ...
   * used to (possibly) insert a new record into the mp table.
   */
  ...
  public void createNewRecordView()
  {
    ...
    //  editor.createView("gov.sao.asc.obsed.view.form.MPNewView",
    //		       "mp", "New Mission Planning", newKeyValue );
  }
