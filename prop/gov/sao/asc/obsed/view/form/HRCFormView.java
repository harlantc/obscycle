...
public class HRCFormView extends FormView 
{
  /****************************************************************************/
  /**
   * Construct a HRCFormView object.
   */
  ...
  public void createNewRecordView()
  {
    ...
    editor.createView( "gov.sao.asc.obsed.view.form.HRCNewView",
		       "hrcparam", "New HRC", newKeyValue );
  }
