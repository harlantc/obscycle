...
/******************************************************************************/
/**
 * <P>The CouldNotConnectException class provides information on a connection
 * error.
 *
 * <P>Each CouldNotConnectException provides several kinds of information: 
 * <UL>
...
public class CouldNotConnectException extends Exception
{
  ...
  public CouldNotConnectException( String reason, String url, String user )
  {
    super( reason );
    this.url = url;
    this.user = user;
