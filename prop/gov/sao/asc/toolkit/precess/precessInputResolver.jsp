...
<table>
  <tr>
    <td align="left" bgcolor="<%= session.getAttribute( "targetNameLabelBGColor" ) %>"><a href="prop_help_precess.jsp#Resolver">Target Name :</a></td>
...
<% }  %>
  ...
  <tr>
    <td align="left"> <a href="prop_help_precess.jsp#NameResolver">Name Resolver :</a>
    </td>
