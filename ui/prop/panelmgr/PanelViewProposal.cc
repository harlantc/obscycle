...
// Constructor
// ----------------------------------------------------------
PanelViewProposal::PanelViewProposal ( int active)
        : ViewMsgCmd ((char *)"Selected Proposal ...",active,PANEL_VIEW_PROP_HTML)
...
// Destructor
// ----------------------------------------------------------
PanelViewProposal::~PanelViewProposal()
{
}
